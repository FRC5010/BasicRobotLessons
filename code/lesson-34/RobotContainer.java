...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // Characterization: two-button combos, on purpose. Nobody holds Back and Y
    // together by accident, which is exactly the point when the fourth command
    // is "spin this wheel open loop until something tells it to stop."
