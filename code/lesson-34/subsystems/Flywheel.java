...
public class Flywheel extends SubsystemBase {
    ...
    // Open-loop characterization. 0.25 V/s, not the 1 V/s default — this wheel
    // is small and direct-drive, so it doesn't stay quasi-static long enough
    // at the default rate. See the lesson for the number that proves it.
