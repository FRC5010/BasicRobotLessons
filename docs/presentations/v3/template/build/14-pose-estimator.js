...
function buildDeck() {
  ...
  // ============================================================ SLIDE 20 — what you learned + next
  {
    ...
    s.addText('Real Vision: PhotonVision', { x: 8.3, y: 3.1, w: 4.0, h: 0.9, fontFace: FONT_HEAD, bold: true, fontSize: 22, color: WHITE, valign: 'top', margin: 0, lineSpacingMultiple: 1.1 });
