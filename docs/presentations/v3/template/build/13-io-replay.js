  ...
  // ============================================================ SLIDE 13 — SwerveModule rewrite: fields+ctor+periodic
  {
    ...
    K.addCodeCard(s, {
      ...
      lines: [
        ...
        { text: '    Telemetry.log(m_logKey + "/SteerAngleDegrees", m_inputs.steerAngleDegrees);', color: '9EF01A' },
        { text: '    Telemetry.log(m_logKey + "/DrivePositionMeters", m_inputs.drivePositionMeters);', color: '9EF01A' },
        { text: '    Telemetry.log(m_logKey + "/DriveVelocityMetersPerSec", m_inputs.driveVelocityMetersPerSec);', color: '9EF01A' },
        { text: '  }', color: 'D7E3F4' },
      ],
    });
